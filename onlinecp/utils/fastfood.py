...
class Fastfood(BaseEstimator, TransformerMixin):
    ...
    Quoc Le, Tamas Sarlos and Alex Smola.
    ...
    def fit(self, X, y=None):
        ...
        self.B = choice([-1, 1], size=(self.times_to_stack_v, self.d), replace=True)
        self.P = np.hstack([(i * self.d) + self.rng.permutation(self.d) for i in range(self.times_to_stack_v)])
    ...
    def transform(self, X):
        ...
        HGPHBX = self.apply_approximate_gaussian_matrix(self.B, self.G, self.P, X_padded)
